...
% cat_features - discrete-valued output feature indices
% labels - {-1, 1}
...
if ~exist('stopval') || isempty(stopval)
    stopval = 0;
end
...
for t = 1:num_iterations
    ...
    dt_classprob=dt.classprob;
    confidences = 1/2*(log(dt_classprob(:, pi)) - log(dt_classprob(:, ni)));             
