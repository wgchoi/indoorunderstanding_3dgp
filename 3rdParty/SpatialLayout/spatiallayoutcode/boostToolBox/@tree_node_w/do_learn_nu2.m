...
function [tree_node_out, split_error] = do_learn_nu2(tree_node, dataset, labels, weights, papa)

tree_node_out = tree_node;

if(nargin > 4)
  tree_node_left.out  = papa;
end
...
if(T_MIN(3,dim)>0)
    tree_node_out.right_constrain = split;
else
    tree_node_out.left_constrain = split;
end
