...
function [Learners, Weights, final_hyp] = RealAdaBoostAsymmetric2(WeakLrn, Data, Labels, Max_Iter, Asymmetry, OldW, OldLrn, final_hyp)
...
for It = 1 : Max_Iter
 ...
 distr=distr.*(exp((Labels*0.5/Max_Iter)*log(Asymmetry)).^(ones(size(ej))-ej));
