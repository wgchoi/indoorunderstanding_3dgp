...
mbg_asserttolequal(double(OO), -27.6, 1e-5);
...
mbg_asserttolequal(double(OO),  -256.2667, 1e-4);
...
mbg_asserttolequal(double(OO),  14, 1e-5);
...
mbg_asserttolequal(double(OO),  -18, 1e-5);
...
mbg_asserttolequal(double(OO+exp(x1)+exp(x2)), -22.5404, 1e-3);
