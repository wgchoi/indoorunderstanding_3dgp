% Model generated from st_bpaf1b.gms
% Created 17-Mar-2008 10:58:17 using YALMIP R20070810
...
objective = -(-(x1*x6+2*x1-2*x6+x2*x7+4*x2-x7+x3*x8+8*x3-2*x8+x4*x9-x4-4*x9+x5*x10-3*x5+5*x10)+0-(0));
...
mbg_asserttolequal(double(objective), -42.9626 , 1e-2);