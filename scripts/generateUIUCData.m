function generateUIUCData()
dirname  = 'uiuccvpr';
dataset = 'UIUC_CVPR';

params = initparam(3, 6);

load(['../Results/layout/' dataset '/res_set_jpg.mat']);

imdir = '../UIUC_CVPR_dataset/Images';
imfiles = dir(fullfile(imdir, '*.jpg'));

detdir = '../Detector/results/DPM_MINE_AUG/UIUC_CVPR';
detfiles = dir(fullfile([detdir '/sofa'], '*.mat'));

annodir = '../UIUC_CVPR_dataset/Annotations';
%%
